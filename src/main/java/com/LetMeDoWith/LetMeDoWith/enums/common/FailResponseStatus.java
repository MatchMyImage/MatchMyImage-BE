...
public enum FailResponseStatus {
    ...
    INVALID_FOLLOWER_MEMBER("INVALID_FOLLOWER_MEMBER", "E211", HttpStatus.BAD_REQUEST, "팔로워 회윈이 유효하지 않습니다."),
    INVALID_FOLLOWING_MEMBER("INVALID_FOLLOW_MEMBER", "E212", HttpStatus.BAD_REQUEST, "팔로잉 가능한 유효 회원이 아닙니다."),
    MEMBER_FOLLOW_NOT_EXIST("MEMBER_FOLLOW_NOT_EXIST", "E213", HttpStatus.BAD_REQUEST, "존재하지 않는 팔로우 이력입니다."),
