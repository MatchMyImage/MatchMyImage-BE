...
public class FollowService {
    ...
    public RetrieveFollowsResDto retrieveFollows(Long memberId,
        ...
        switch (followType) {
            ...
            case FOLLOWING -> {
                List<MemberFollow> memberFollows = memberFollowRepository.findAllFollowingsByFollowerMemberFetchJoinMember(
                    member,
                    pageable);
                result = RetrieveFollowsResDto.builder().follows(memberFollows.stream()
                                                                              .map(e -> new RetrieveFollowsResDto.Follow(
    ...
    public void createFollow(Long memberId, Long followingMemberId) {
        ...
        Member followingMember = memberRepository.findByIdAndStatus(followingMemberId,
                                                                    MemberStatus.NORMAL)
                                                 .orElseThrow(() -> new RestApiException(
    ...
    public void deleteFollow(Long memberId, Long followingMemberId) {
        ...
        MemberFollow memberFollow = memberFollowRepository.findAllByFollowerMemberIdAndFollowingMemberId(
                                                              memberId,
                                                              followingMemberId)
                                                          .orElseThrow(() -> new RestApiException(
